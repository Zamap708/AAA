...
export default function Hero() {
  return (
    <div className="relative h-screen w-screen p-0 m-0 overflow-hidden bg-black/60">
      ...
      <div className="relative flex flex-col m-auto w-3/5 overflow-hidden h-full items-center justify-center border-white">
