...
export default function Nominee(props) {
  return (
      <div className={`relative h-[500px] w-full z-10 flex hover:scale-110 transition-transform duration-300 ease-in-out`}>
        <div className="h-full w-full p-8 flex justify-center items-center gap-4 bg">
          <div className="flex flex-col h-full w-full rounded-2xl">
            <div className="flex h-1/8 w-full justify-end   ">
              ...
              <div className={`h-full w-2/3 px-1 rounded-t-2xl border-b-0 flex justify-start items-center ${props.isSelected ? "bg-[#0089CD] text-[#fff]" : "bg-[#46484C]/80 text-white"} `}>
